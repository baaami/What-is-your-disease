...
import { BASE_CLIENT_URL } from 'shared/api_constant'

const KAKAO_CLIENT_ID = config.KAKAO_CLIENT_ID
const KAKAO_REDIRECT_URI = `${BASE_CLIENT_URL}/auth/callback/kakao`

export const KAKAO_AUTH_URL = `https://kauth.kakao.com/oauth/authorize?client_id=${KAKAO_CLIENT_ID}&redirect_uri=${KAKAO_REDIRECT_URI}&response_type=code`

const NAVER_CLIENT_ID = config.NAVER_CLIENT_ID
const NAVER_REDIRECT_URI = `${BASE_CLIENT_URL}/auth/callback/naver`
...
const GOOGLE_REDIRECT_URI = `${BASE_CLIENT_URL}/auth/callback/google`
